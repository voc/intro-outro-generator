        ...
        for room in day.iter("room"):
            ...
            for event in room.iter("event"):
                ...
                if id in titlemap:
                    ...
                    event.find("title") is not None
                    and event.find("title").text is not None
                ):
                ...
                if (
                    event.find("subtitle") is not None
                    and event.find("subtitle").text is not None
                ):
                ...
                if (
                    event.find("track") is not None
                    and event.find("track").text is not None
                ):

...
# URL to Schedule-XML
scheduleUrl = 'http://frab.fossgis-konferenz.de/de/2018/public/schedule.xml'
...
def tasks(queue, args, idlist, skiplist):
	...
	for event in events(scheduleUrl):
		if event['room'] not in ('Wolfgang-Paul-Hörsaal', 'Alfred-Philippson-Hörsaal', 'Hörsaal II - Geozentrum', 'Hörsaal IV - Geozentrum', 'Roter Saal'):

...
# URL to Schedule-XML
scheduleUrl = 'http://data.c3voc.de/fusion24/schedule.xml'
...
def debug():
    render(
        ...
        {
            '$ID': 4711,
            '$TITLE': "Walking eye-gazing meditation",
            '$SUBTITLE': 'Long Long Long Long subtitle is LONGER',
            '$SPEAKER': 'Tuva Bjørnstad'
        }
    )
...
def tasks(queue, args, idlist, skiplist = ['pause']):
